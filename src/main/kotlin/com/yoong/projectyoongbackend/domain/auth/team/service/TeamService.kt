...
class TeamService(
    ...
    fun updateTeam(teamRequest: TeamRequest, teamId: Long): DefaultResponse {
        ...
        val team = teamRepository.findByIdOrNull(teamId) ?: throw ModelNotFoundException(404, "팀이 존재 하지 않습니다")
    ...
    fun deleteTeam(teamId: Long, leaderId: Long): DefaultResponse {
        ...
        val leader = memberRepository.findByIdOrNull(leaderId) ?: throw ModelNotFoundException(404, "리더가 존재 하지 않습니다")
    ...
    fun grantManagerPrivileges(userId: Long, teamId: Long): DefaultResponse {
        ...
        val member = memberRepository.findByIdOrNull(userId) ?: throw ModelNotFoundException(404, "맴버가 존재 하지 않습니다")
    ...
    fun firedTeam(teamId: Long, userId: Long): DefaultResponse {
        ...
        val team = teamRepository.findByIdOrNull(teamId) ?: throw ModelNotFoundException(400, "팀이 존재 하지 않습니다")

        val dummyTeam = teamRepository.findByDummyTeam()

        val member = memberRepository.findByIdOrNull(userId) ?: throw ModelNotFoundException(400, "맴버가 존재 하지 않습니다")
